# Component Documentation — SentinelIQ
...
SentinelIQ's UI is built entirely with **vanilla TypeScript** — no React, Vue, or
...
SentinelIQ ships two independent map renderers and an adapter that picks the
