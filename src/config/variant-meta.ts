...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'SentinelIQ - Real-Time Global Intelligence Dashboard',
  ...
  tech: {
    ...
    siteName: 'SentinelIQ Tech',
    shortName: 'SentinelIQ Tech',
  ...
  happy: {
    ...
    siteName: 'SentinelIQ Happy',
    shortName: 'SentinelIQ Happy',
  ...
  finance: {
    ...
    siteName: 'SentinelIQ Finance',
    shortName: 'SentinelIQ Finance',
  ...
  commodity: {
    title: 'SentinelIQ Commodity - Real-Time Commodity Markets & Supply Chain Dashboard',
    ...
    siteName: 'SentinelIQ Commodity',
    shortName: 'SentinelIQ Commodity',
