...
If you discover a security vulnerability in SentinelIQ, please report it responsibly:
...
SentinelIQ is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- SentinelIQ aggregates publicly available OSINT data
...
- Vulnerabilities in the SentinelIQ codebase
...
Thank you for helping keep SentinelIQ and its users safe! 🔒
