...
description: "SentinelIQ's Cmd+K command palette lets you fuzzy-search across countries, layers, panels, news, markets, military bases, and more. 150+ commands, 195 countries."
metaTitle: "SentinelIQ Command Palette: Search 24 Data Types, 195 Countries Instantly"
...
In most dashboards, that's four separate navigation actions. In SentinelIQ, it's one: **Cmd+K** (or Ctrl+K on Windows/Linux), type what you need, hit Enter.

## The 150+ Command Universe

SentinelIQ's command palette is a fuzzy-search interface that spans the entire platform. Hit Cmd+K and you can access:
...
No mouse needed. For analysts who live in the keyboard, this means SentinelIQ's entire intelligence platform is accessible without touching a pointing device.
...
The command palette turns SentinelIQ from a visual dashboard into a queryable intelligence system. Ask it anything, get there instantly.
...
SentinelIQ's Cmd+K reduces the path from question to answer to a single search query. Type what you need, press Enter, and you're looking at it. For professionals who make time-sensitive decisions based on global intelligence, that speed compounds into a significant advantage.
