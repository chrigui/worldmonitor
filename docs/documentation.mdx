---
title: "Introduction"
description: "SentinelIQ is an open-source, real-time global intelligence dashboard that aggregates news, markets, military activity, infrastructure data, and AI-powered analysis into a single map interface."
---

SentinelIQ brings together 344 curated news sources, 49 interactive map layers, and AI-powered analysis into a situational awareness platform. It runs five specialized variants from a single codebase, each tailored to a different domain: geopolitics, technology, finance, commodities, and positive global trends.
...
SentinelIQ is open source under [AGPL-3.0](/license). Free for personal, educational, and research use. Commercial use requires a [separate license](/license#commercial-use-requires-a-separate-license).
