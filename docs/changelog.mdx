---
title: "Changelog"
description: "All notable changes to SentinelIQ, organized by release."
rss: true
---

All notable changes to SentinelIQ are documented here. Subscribe via [RSS](/changelog/rss.xml) to stay updated.
