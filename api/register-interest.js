...
async function sendConfirmationEmail(email, referralCode) {
  ...
  const shareText = encodeURIComponent('I just joined the SentinelIQ Pro waitlist \u2014 real-time global intelligence powered by AI. Join me:');
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the SentinelIQ Pro waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: 'You\u2019re on the SentinelIQ Pro waitlist',
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto 32px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <div style="font-size: 16px; font-weight: 800; color: #fff; letter-spacing: -0.5px;">SENTINELIQ</div>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              ...
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                SentinelIQ \u2014 Real-time intelligence for a connected world.<br />
